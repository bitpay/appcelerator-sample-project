...
//@interface BitPay_APIObject : NSObject
//@end

@interface BitPay_APIObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
  ...
  if (o) {
    ...
    if ([o isKindOfClass:[BitPay_APIObject class]]) {
      for (NSString *key in [[(BitPay_APIObject *)o modules] allKeys]) {
