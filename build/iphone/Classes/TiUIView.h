...
/**
 Base class for all BitPay_API views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the BitPay_API view hierarchy (such as wrapped iOS UIViews) was touched.
