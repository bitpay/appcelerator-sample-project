 ...
 * to send analytic data that can be viewed on the BitPay_API Dashboard.
 *
 * For information on getting started with BitPay_API Platform Services,
 * see [BitPay_API Platform Services for iOS](http://bit.ly/1kqteQS).
 */
