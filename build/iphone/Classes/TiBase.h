...
// in simulator we redefine to format for BitPay_API Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.bitpay_api." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.bitpay_api";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIBitPay_APINativeItemNone = -1,
  UIBitPay_APINativeItemSpinner = -2,
  UIBitPay_APINativeItemProgressBar = -3,

  UIBitPay_APINativeItemSlider = -4,
  UIBitPay_APINativeItemSwitch = -5,
  UIBitPay_APINativeItemMultiButton = -6,
  UIBitPay_APINativeItemSegmented = -7,

  UIBitPay_APINativeItemTextView = -8,
  UIBitPay_APINativeItemTextField = -9,
  UIBitPay_APINativeItemSearchBar = -10,

  UIBitPay_APINativeItemPicker = -11,
  UIBitPay_APINativeItemDatePicker = -12,

  UIBitPay_APINativeItemInfoLight = -13,
  UIBitPay_APINativeItemInfoDark = -14,

  UIBitPay_APINativeItemDisclosure = -15,

  UIBitPay_APINativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all BitPay_API instances of
