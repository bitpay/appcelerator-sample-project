...
/**
 The base class for all BitPay_API modules
 */
...
/**
 BitPay_API Platform calls this method on startup.
 */
- (void)startup;

/**
 BitPay_API Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
- (void)shutdown:(id)sender;

/**
 BitPay_API Platform calls this method on suspend.
 @param sender The sender of the event.
 */
- (void)suspend:(id)sender;

/**
 BitPay_API Platform calls this method on entering background.
 @param sender The sender of the event.
 */
- (void)paused:(id)sender;

/**
 BitPay_API Platform calls this method on resume.
 @param sender The sender of the event.
 */
